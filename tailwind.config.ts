  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'lid-explode': {
            '0%': { transform: 'translateZ(0px) rotateX(0deg)', opacity: '1' },
            '100%': { transform: 'translateZ(300px) rotateX(45deg) rotateZ(90deg)', opacity: '0' },
        },
        'bow-fly': {
      ...
      animation: {
        ...
        'lid-explode': 'lid-explode 0.8s cubic-bezier(0.6, -0.28, 0.735, 0.045) forwards',
