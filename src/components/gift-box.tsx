...
export default function GiftBox({ onClick }: GiftBoxProps) {
  ...
  return (
    ...
    >
      <div className="relative w-36 h-32 group-hover:animate-shake">
        {/* Box Base */}
        <div className="absolute bottom-0 w-full h-full bg-gradient-to-br from-secondary to-background border-2 border-primary/50 rounded-md"></div>
        {/* Box Ribbon Vertical */}
        ...
        <div
          className={cn(
            'absolute -top-4 left-1/2 -translate-x-1/2 w-[152px] h-8 bg-gradient-to-b from-primary to-golden-amber rounded-t-md transition-transform duration-500 ease-out origin-bottom-right',
